    ...
    if (typeof console !== "undefined") {
      ...
      console.log(
        "%cWhoa, look at you! 🕵️‍♂️\n" +
          ...
          "Just type %cKhushhal%c and hit enter! 🎩🐇",
      ...
      ["khushhal", "Khushhal", "KHUSHHAL"].forEach((name) => {
        // @ts-ignore
        if (Object.hasOwn(window, name)) return;
        Object.defineProperty(window, name, {
          get() {
            console.log(
              "%c😏 Oh… so you found it.\n\n" +
                "You've officially summoned **Khushhal's magic** 🧙‍♂️✨\n" +
                "Not impressed yet? Relax — legends don't need validation.\n\n" +
                "Just don't misuse this power… or the console bites back ⚡🐱",
            ...
            const timer = setTimeout(() => {
              console.log(
                "%cPssttt! 🤫\n\n" +
                  "Do you like cats?? 😺 If yes, then press 'n' anywhere on the website and see what happens! 🐱✨",
